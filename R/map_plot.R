...
#' (ii) each indicator name, for ebp and direct objects: "Mean", "Quantile_10",
#' "Quantile_25", "Median", "Quantile_75", "Quantile_90", "Head_Count",
#' "Poverty_Gap", "Gini", "Quintile_Share" or the function name/s of
#' "custom_indicator/s"; for fh objects, "FH" or "Direct";
#' (iii) groups of indicators (only for ebp and direct): "Quantiles", "Poverty" or
#' "Inequality". Defaults to "all". Note, additional custom indicators can be
#' defined as argument for the direct and ebp estimation (see also \code{\link{ebp}} and
#' \code{\link{direct}}) and do not appear in groups of indicators even though
